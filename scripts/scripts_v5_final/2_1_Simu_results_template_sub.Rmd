...
if(sn == 7){
  ...
  results_0 = run_simu_rep_summary(results_0)
  # save.image(file=here("data", "rdata", paste0("02_simu_V5_sys", sn, "_", nn, "_default.RData")))
}
...
results_adapt1 = smoothness_adaptive_HAL_summary(results_adapt$result_list)
