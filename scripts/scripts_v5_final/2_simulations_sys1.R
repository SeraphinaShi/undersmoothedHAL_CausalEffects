...
save.image(file=here("data", "rdata", "02_simu_V5_sys1_200_default.RData"))
...
save.image(file=here("data", "rdata", "02_simu_V5_sys1_200_adapt.RData"))
...
set.seed(123)
results_gam <- run_simu_gam_poly_rep(generate_data_1, eval_points, y_type = "binomial", n=n, rounds=500, return_all_rslts=T, method = "GAM")
save.image(file=here("data", "rdata", "02_simu_V5_sys1_500_GAM.RData"))
