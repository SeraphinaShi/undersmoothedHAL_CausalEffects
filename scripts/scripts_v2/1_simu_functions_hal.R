...
undersmooth_hal_local <- function(X,
                                  Y,
                                  a,
                                  z = NULL,
                                  fit_init,
  ...
  #   max_score <- get_maxscore_local(basis_mat = basis_mat,
  #                                   resid_mat = resid_mat,
  #                                   sd_est = sd_est,
  #                                   Nlam = Nlam, 
  #                                   us_fit = us_fit, 
...
# cal_ate_hal <- function(hal_fit, n, X, Y, a, z){
#   
#   X1 <- X
#   X1$A = a1
#   X1$Z = z
...
get_maxscore_local <- function(basis_mat, resid_mat, sd_est, Nlam, us_fit, a, z){
