...
# set.seed(123)
# n = nn
# results_under <- run_simu_1round(generate_data_1, n=nn, undersmooth='global')
# psi_10pnt <- merge(as.data.frame(psi0_10pnt), as.data.frame(results_under), by=c("a", "z"))
# 
# 
# ## ----simu_sys1_n200_B_u, fig.width=6, fig.height=7------------------------------------------------------------------------------------
# set.seed(123)
# simu_results <- run_simu_rep(generate_data_1, n=nn, B=1000, return_all_rslts=T,  undersmooth='global')
# 
# save.image(file=here("data", "rdata", "02_simu_V3_sys1_200_U.RData"))


## ----simu_sys1_n200_1_u_local, fig.width=6, fig.height=4------------------------------------------------------------------------------------
set.seed(123)
n = nn
...
## ----simu_sys1_n200_B_u_local, fig.width=6, fig.height=7------------------------------------------------------------------------------------
set.seed(123)
simu_results <- run_simu_rep(generate_data_1, n=nn, B=1000, return_all_rslts=T,  undersmooth='local')

save.image(file=here("data", "rdata", "02_simu_V3_sys1_200_U_l.RData"))
