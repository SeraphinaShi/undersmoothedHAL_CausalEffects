...
# 
# save.image(file=here("data", "rdata", "02_simu_V4_sys1_psi0.RData"))

load(here("data", "rdata", "02_simu_V4_sys1_psi0.RData"))
source(here("scripts", "scripts_v4", "1_simu_functions_hal9001.R"))
source(here("scripts", "scripts_v4", "1_simu_functions.R"))
...
# save.image(file=here("data", "rdata", "02_simu_V4_sys1_1000.RData"))

results_grid <- run_simu_scaled_rep(generate_data_1, n=n, B=1000, return_all_rslts=T)
save.image(file=here("data", "rdata", "02_simu_V4_sys1_1000_grid.RData"))
