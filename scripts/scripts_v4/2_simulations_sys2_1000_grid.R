...
# results <- run_simu_rep(generate_data_2, n=n, B=1000, return_all_rslts=T)
# save.image(file=here("data", "rdata", "02_simu_V4_sys2_1000.RData"))

results_grid <- run_simu_scaled_rep(generate_data_2, n=n, B=1000, return_all_rslts=T)
save.image(file=here("data", "rdata", "02_simu_V4_sys2_1000_grid.RData"))
#
