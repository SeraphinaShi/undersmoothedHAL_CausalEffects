...
simu_results_U$method = "U_Global"
```
...
### Globally Undersmoothed HAL with min local lambda
```{r}
load(here("data", "rdata", paste0("02_simu_V3_sys", sn, "_", nn, "_U_l.RData")))
```
...
cols_to_convert <- names(psi_10pnt)[names(psi_10pnt) != 'hal_fit_time_unit']
psi_10pnt[cols_to_convert]  <- lapply(psi_10pnt[cols_to_convert], as.numeric)
...
avg_u_l_scaler <- mean(simu_results$result_summary$lambda)/mean(simu_results$result_summary$CV_lambda)
...
simu_results_U_l <- simu_results$result_summary
simu_results_U_l$method = "U_Lmin"
```
...
simu_results_CV_U <- rbind(simu_results_CV, simu_results_U) %>% rbind(simu_results_U_l %>% select(names(simu_results_CV)))
...
plot_perforences_alllambda_1a(df=simu_results_all, a_para = 0.5, z_para = 1, add_oracal=T, u_g_scaler=avg_u_scaler, u_l_scaler=avg_u_l_scaler)
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a05_z1.png")))
```

```{r , fig.height=5.5, fig.width=5.5}
plot_perforences_alllambda_1a(simu_results_all, a_para = 2, z_para = 1, add_oracal=T, u_g_scaler=avg_u_scaler, u_l_scaler=avg_u_l_scaler)
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a2_z1.png")))
```

```{r , fig.height=5.5, fig.width=5.5}
plot_perforences_alllambda_1a(simu_results_all, a_para = 2.5, z_para = 1, add_oracal=T, u_g_scaler=avg_u_scaler, u_l_scaler=avg_u_l_scaler)
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a25_z1.png")))
```

```{r , fig.height=5.5, fig.width=5.5}
plot_perforences_alllambda_1a(simu_results_all, a_para = 3, z_para = 1, add_oracal=T, u_g_scaler=avg_u_scaler, u_l_scaler=avg_u_l_scaler)
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a3_z1.png")))
```

```{r , fig.height=5.5, fig.width=5.5}
plot_perforences_alllambda_1a(simu_results_all, a_para = 4, z_para = 1, add_oracal=T, u_g_scaler=avg_u_scaler, u_l_scaler=avg_u_l_scaler)
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a4_z1.png")))
```

```{r , fig.height=5.5, fig.width=5.5}
plot_perforences_alllambda_1a(simu_results_all, a_para = 5, z_para = 1, add_oracal=T, u_g_scaler=avg_u_scaler, u_l_scaler=avg_u_l_scaler)
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a5_z1.png")))
```


```{r , fig.height=5.5, fig.width=5.5}
plot_perforences_alllambda_1a(simu_results_all, a_para = 0.5, z_para = 0, add_oracal=T, u_g_scaler=avg_u_scaler, u_l_scaler=avg_u_l_scaler)
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a05_z0.png")))
```

```{r , fig.height=5.5, fig.width=5.5}
plot_perforences_alllambda_1a(simu_results_all, a_para = 2, z_para = 0, add_oracal=T, u_g_scaler=avg_u_scaler, u_l_scaler=avg_u_l_scaler)
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a2_z0.png")))
```

```{r , fig.height=5.5, fig.width=5.5}
plot_perforences_alllambda_1a(simu_results_all, a_para = 2.5, z_para = 0, add_oracal=T, u_g_scaler=avg_u_scaler, u_l_scaler=avg_u_l_scaler)
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a25_z0.png")))
```

```{r , fig.height=5.5, fig.width=5.5}
plot_perforences_alllambda_1a(simu_results_all, a_para = 3, z_para = 0, add_oracal=T, u_g_scaler=avg_u_scaler, u_l_scaler=avg_u_l_scaler)
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a3_z0.png")))
```

```{r , fig.height=5.5, fig.width=5.5}
plot_perforences_alllambda_1a(simu_results_all, a_para = 4, z_para = 0, add_oracal=T, u_g_scaler=avg_u_scaler, u_l_scaler=avg_u_l_scaler)
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a4_z0.png")))
```

```{r , fig.height=5.5, fig.width=5.5}
plot_perforences_alllambda_1a(simu_results_all, a_para = 5, z_para = 0, add_oracal=T, u_g_scaler=avg_u_scaler, u_l_scaler=avg_u_l_scaler)
