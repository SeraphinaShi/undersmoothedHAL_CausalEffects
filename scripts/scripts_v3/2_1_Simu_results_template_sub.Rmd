...
### CV HAL
```{r}
load(here("data", "rdata_v3", paste0("02_simu_V3_sys", sn, "_", nn, "_CV.RData")))
```
...
```{r}
load(here("data", "rdata_v3", paste0("02_simu_V3_sys", sn, "_", nn, "_U.RData")))
```
...
load(here("data", "rdata_v3", paste0("02_simu_V3_sys", sn, "_", nn, "_grid.RData")))
```

```{r simu_sys_n_B_grid_05_1, fig.height=5.5, fig.width=5.5}
plot_perforences_alllambda_1a(simu_results_all, a_para = 0.5, z_para = 1, add_oracal=T, avg_u_scaler = avg_u_scaler)
