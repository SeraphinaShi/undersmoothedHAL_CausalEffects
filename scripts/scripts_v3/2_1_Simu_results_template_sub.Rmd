...
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_n", nn ,"_1_cv.png")), p)
```
...
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_n", nn ,"_1_u.png")), p)
```
...
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a05_z1.png")), p0_list)
```
...
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a2_z1.png")), p0_list)
```
...
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a25_z1.png")), p0_list)
```
...
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a3_z1.png")), p0_list)
```
...
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a4_z1.png")), p0_list)
```
...
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a5_z1.png")), p0_list)
```
...
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a05_z0.png")), p0_list)
```
...
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a2_z0.png")), p0_list)
```
...
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a25_z0.png")), p0_list)
```
...
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a3_z0.png")), p0_list)
```
...
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a4_z0.png")), p0_list)
```
...
ggsave(here(getwd(), "plots", paste0("simu_sys", sn, "_z0", "_n", nn ,"_B_grid_a5_z0.png")), p0_list)
```
