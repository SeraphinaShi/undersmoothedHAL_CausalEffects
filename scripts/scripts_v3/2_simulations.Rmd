...
save.image(file=here("data", "rdata", "02_simu_V3_sys1_200_psi0.RData"))
#------------------------------------------------------------------------------------
# load(file=here("data", "rdata", "02_simu_V3_sys1_200_psi0.RData"))
#------------------------------------------------------------------------------------
...
#### results
```{r simu_sys1_1_n200_rslt, fig.width=6, fig.height=4}
...
```{r simu_sys1_B_n200_rslt, fig.width=6, fig.height=7}
set.seed(123)
...
#### results
```{r simu_sys1_1_n200_rslt_u, fig.width=6, fig.height=4}
p1 <- plot_perforences_1lambda_alla(psi_10pnt, z_para=1, est_plot_only = T) +
  labs(title = "z=1") + theme(plot.title = element_text(hjust = 0.5))
p0 <- plot_perforences_1lambda_alla(psi_10pnt, z_para=0, est_plot_only = T) +
  labs(title = "z=0") + theme(plot.title = element_text(hjust = 0.5))
...
```{r simu_sys1_B_n200_rslt_u, fig.width=6, fig.height=7}
set.seed(123)
...
<!-- ```{r simu_sys1_B_n200_rslt_grid_05_1, fig.height=5.5, fig.width=5.5} -->
<!-- # load(here("data", "rdata", "02_simu_V3_sys1_200_grid.RData")) -->
<!-- plot_perforences_alllambda_1a(simu_results_all, a = 0.5, z = 1) -->
<!-- ``` -->

<!-- ```{r simu_sys1_B_n200_rslt_grid_05_0, fig.height=5.5, fig.width=5.5} -->
<!-- plot_perforences_alllambda_1a(simu_results_all, a = 0.5, z = 0) -->
<!-- ``` -->

<!-- ```{r simu_sys1_B_n200_rslt_grid_5_1, fig.height=5.5, fig.width=5.5} -->
<!-- plot_perforences_alllambda_1a(simu_results_all, a = 5, z = 1) -->
<!-- ``` -->

<!-- ```{r simu_sys1_B_n200_rslt_grid_5_0, fig.height=5.5, fig.width=5.5} -->
<!-- plot_perforences_alllambda_1a(simu_results_all, a = 5, z = 0) -->
<!-- ``` -->
