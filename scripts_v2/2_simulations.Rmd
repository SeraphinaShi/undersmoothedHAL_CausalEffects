...
source(here("scripts_v2", "1_simu_functions_hal.R"))
source(here("scripts_v2", "1_simu_functions.R"))
```
...
save.image(file=here("data", "rdata", "02_simulation_1_200_true_psi.RData"))
```
...
save.image(file=here("data", "rdata", "02_simulation_1_200_v2.RData"))
```

### results
```{r}
load(here("data", "rdata", "02_simulation_1_200_v2.RData"))
